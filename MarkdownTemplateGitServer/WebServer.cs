    ...
    class WebServer
    {
        ...
        async Task RunAsync()
        {
            while (true)
            {
                ...
                var item = await _server.GetContextAsync();
                try
                {
                        ...
                        var markdown = new Markdown
                            {
                                ...
                                AdvancedStyles = {TableClasses = "table table-striped"}
                            };
                    ...
                    item.Response.ContentType = GetMimeType(Path.GetExtension(path));
                    item.Response.Close(blob.RawData, false);
                }
                catch (Exception ex)
                {
